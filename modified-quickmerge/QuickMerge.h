...
struct rank 
{
	...
	int lengthList; 								 // QUANTIDADE TOTAL DE ELEMENTOS 
	int lengthHighList;								 // QUANTIDADE DE ELEMENTOS MAIORES QUE O PIVÔ
	int lengthLowList;   							 // QUANTIDADE DE ELEMENTOS MENORES QUE O PIVÔ
	...
	MPI_Comm Comm;									 // COMUNICADOR DO MPI COM PROCESSOS ATIVOS
...
// CALCULA O PIVÔ DE ACORDO COM O INDEX
int calcPivo(Processo *processo, int index, int meusInstaveis_rank);
